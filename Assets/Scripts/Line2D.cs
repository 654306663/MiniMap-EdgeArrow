...
public class Line2D  {
    ...
    private bool CheckCross(Vector2 sp1, Vector2 ep1, Vector2 sp2, Vector2 ep2)
    {
        ...
        Vector2 vectorA = sp1 - sp2;
        Vector2 vectorB = ep2 - sp2;
        Vector2 vectorC = ep2 - sp2;
        Vector2 vectorD = ep1 - sp2;
